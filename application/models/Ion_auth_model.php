...
class Ion_auth_model extends CI_Model {
    ...
    public function front_register($identity, $password, $email, $additional_data = array(), $groups = array()) {
        $this->trigger_events('pre_register');
...
//echo $this->db->last_query();
    ...
    public function users_admin($groups = NULL) {
        $this->trigger_events('users');
        ...
        if (isset($this->_ion_select) && !empty($this->_ion_select)) {
            ...
            $this->db->where('admin_id', $this->ion_auth->get_user_id());
            //$this->db->where('id',1);
        }
